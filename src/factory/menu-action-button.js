...
`,
            `<div tabindex="-1" role="presentation" style="outline: none; transition-duration: 80ms; animation-duration: 80ms;"><div role="presentation"><div id="slack-kit-tooltip" role="tooltip" class="c-tooltip__tip c-tooltip__tip--top" data-qa="tooltip-tip">${label}<div class="c-tooltip__tip__arrow"></div></div></div></div>`
        );
    }
}
